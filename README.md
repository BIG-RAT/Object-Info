...
The applicatoin will submit basic hardware, OS, and Object Info application usage to [TelemetryDeck](https://telemetrydeck.com). The data is sent anonymously and used to aid in the development of the application. To opt out of data the sending of data click 'Opt out of analytics' at the bottom of the 'About Object Info' window.
